public enum Roman {
     O, I, II, III, IV, V, VI, VII, VIII, IX, X, XI, XII, XIII, XIV, XV, XVI, XVII, XVIII, XIX, XX, XXI, XXII, XXIII, XXIV, XXV, XXVI, XXVII, XXVIII, XXIX, XXX, XXXI, XXXII, XXXIII, XXXIV, XXXV, XXXVI, XXXVII, XXXVIII, XXXIX, XL,
     ...
     static String getString(int num){
          for(Roman rom: Roman.values()){
               if(num== rom.ordinal()) return rom.toString();//System.out.println(rom.toString());
          }
          return "";
     }
}
